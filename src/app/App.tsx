  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="MenuManagement" component={MenuManagement} options={{ title: 'Menu Management' }} />
        <Stack.Screen name="PromotionList" component={PromotionList} options={{ title: 'Promotions' }} />
        <Stack.Screen name="IncomingOrder" component={IncomingOrder} options={{ title: 'Orders' }} />
